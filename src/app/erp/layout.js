...
export default function ErpLayout({ children }) {
  ...
  const links = [
    ...
    { name: language === 'ar' ? 'الأعضاء والاشتراكات' : 'Members Directory', path: '/erp/members', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { name: language === 'ar' ? 'الشركات المستأجرة' : 'Company Accounts', path: '/erp/companies', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { name: language === 'ar' ? 'إدارة الحجوزات' : 'Bookings Engine', path: '/erp/bookings', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
